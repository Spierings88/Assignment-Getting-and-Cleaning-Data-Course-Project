...
# Set the working directory to the file containing the CI HAR Dataset. Here the neded In my case the filepath is:
setwd("C:\\Users\\Martijn\\Documents\\R\\Getting and cleaning data\\UCI HAR Dataset")
